        ...
        <div className="container">
          <div className="row align-items-center">
            ...
            <div className="col-md-7 col-lg-6 text-md-start text-center py-6">
              ...
              <h1 className="fs-6 fs-xl-7 mb-5">Learn New Skills Online Find Best Courses</h1><a className="btn btn-primary me-2" href="#!" role="button">Get A Quote</a><a className="btn btn-outline-secondary" href="#!" role="button">Read more</a>
            </div>
          </div>
        </div>
      </section>
