          ...
          <div className="card-body">
            <div className="row flex-center gx-0">
              ...
              <div className="col-lg-8 col-xl-4">
                <h1 className="text-light fs-lg-4 fs-xl-5">Upcoming Our <span className="text-primary">Basic in Python </span>Course!</h1>
              </div>
              <div className="col-lg-12 col-xl-6">
                <h1 className="display-1 text-light text-center text-xl-end">11 : 02 : 45 : 21</h1>
              </div>
            </div>
          </div>
        </div>
